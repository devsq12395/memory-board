/*
  This file contains global constant values for the project.
  You can import these constants in other parts of the codebase for consistent values.
*/
...
export const SHOP_ITEM_IDS = [
  "ff23db7c-4ba8-448f-b4ab-4eb617e92ba5" // Add memory limit
]